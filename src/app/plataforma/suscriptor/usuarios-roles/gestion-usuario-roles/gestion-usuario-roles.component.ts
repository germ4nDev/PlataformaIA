...
@Component({
    ...
    templateUrl: './gestion-usuario-roles.component.html',
    styleUrl: './gestion-usuario-roles.component.scss'
})
export class GestionUsuarioRolesComponent implements OnInit {
    ...
    empresasSuscriptor: PTLEmpresaSCModel[] = [];
    ...
    ngOnInit() {
        ...
        this.empresasSuscriptor = empsSC;
        console.log('empresas del suscriptror', this.empresasSuscriptor);

        const usuSC = this.usuariosSC.find(x => x.codigoSuscriptor == this.codigoSuscriptor && x.codigoUsuario == this.codigoUsuario);
