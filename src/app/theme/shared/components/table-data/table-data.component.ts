...
export class TableDataComponent implements OnInit, OnChanges, AfterViewInit {
    ...
    @Input() showDetailActions: boolean = false
    ...
    @Input() showUploadModalButton: boolean = false;
    @Input() uploadModalLabel: string = 'Cargar Excel Masivo';

    // 🟢 2. Nuevo Output que avisa al componente padre
    @Output() uploadModalClick = new EventEmitter<void>();
    ...
    onUploadModalClick(): void {
        this.uploadModalClick.emit();
    }
