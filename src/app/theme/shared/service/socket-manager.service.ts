...
// //     // 🟢 NUEVO: Canal para el widget de usuarios conectados y auditoría de sesiones
...
// //     // ... (tus demás propiedades se mantienen exactamente igual)
...
// //         // 🟢 NUEVO: Listener para capturar el evento que emite el backend de sesiones
...
// import { Subject } from 'rxjs';
// import { Router } from '@angular/router'; // 🟢 Inyectado para expulsión
// import { SocketService } from './sockets.service';
// import { LocalStorageService } from './local-storage.service';
// import Swal from 'sweetalert2'; // 🟢 Importado para la alerta
...
//         // 🚨 NUEVO: Cierre de Sesión Concurrente (El Golpe de Gracia)
...
//     //     // 1. Extracción BLINDADA del usuario actual
//     //     let currentUser = null;
//     //     try {
//     //         const rawUser = localStorage.getItem('currentUser') || sessionStorage.getItem('currentUser');
//     //         if (rawUser) {
//     //             const parsed = JSON.parse(rawUser);
//     //             currentUser = parsed?.codigoUsuario || parsed?.usuario?.codigoUsuario || parsed?.id || null;
//     //         }
//     //         if (!currentUser) {
//     //             currentUser = localStorage.getItem('codigoUsuario');
//     //         }
//     //     } catch (e) {
//     //         currentUser = localStorage.getItem('codigoUsuario');
//     //     }

//     //     // 2. Extracción de la sesión local
//     //     const currentSession = sessionStorage.getItem('codigoSesionActiva');

//     //     // 3. Conversión a String estricta
...
//     //     console.log(`🔍 [MANAGER] Evaluación de expulsión:
//     //         - Mi Usuario local: ${localUserStr} | Usuario entrante: ${incomingUserStr}
//     //         - Mi Sesión local: ${localSessionStr} | Sesión entrante: ${incomingSessionStr}
//     //     `);

//     //     // 4. Si soy el mismo usuario, pero mi sesión es distinta a la nueva -> ¡Pa' fuera!
...
//     //         // Usamos el inyector para evitar la dependencia circular (DI)
//     //         const swalService = this.injector.get(SwalAlertService);
//     //         const router = this.injector.get(Router);

//     //         const descripcion = 'Se ha iniciado sesión con tu usuario desde otro dispositivo o pestaña. Por tu seguridad, esta sesión ha sido cerrada.';
//     //         const titulo = 'Sesión Finalizada';
//     //         const confirmButtonText = 'Ir al Login';
//     //         const cancelButtonText = 'Cancelar';

//     //         swalService.getAlertQuestionRequest(descripcion, titulo, confirmButtonText, cancelButtonText).subscribe(() => {
...
//         // 🟢 1. Extraemos TODO de una sola fuente
//         const rawUser = localStorage.getItem('currentUser') || sessionStorage.getItem('currentUser');
//         let currentUser = null;
//         let currentSession = null; // 🟢 Nueva variable

//         if (rawUser) {
//             const parsed = JSON.parse(rawUser);
//             // Dependiendo de cómo guardes exactamente el JSON
...
//         console.log(`🔍 [MANAGER] Evaluación de expulsión:
//             - Mi Usuario: ${localUserStr} | Entrante: ${incomingUserStr}
//             - Mi Sesión: ${localSessionStr} | Entrante: ${incomingSessionStr}
//         `);

//         // 3. Condición de expulsión
//         if (incomingUserStr === localUserStr && incomingSessionStr !== localSessionStr) {
//             console.warn('⚠️ [MANAGER] ¡Cierre forzado! Sesión abierta en otro navegador.');
...
//     // 🟢 MÉTODOS EMISORES ÚTILES PARA EL FLUJO DE SESIÓN
//     public registrarSesion(userData: any): void {
//         // Nota: Como ahora registramos la sesión vía HTTP para proteger la BD,
//         // podrías eliminar esto si ya no lo llamas desde el Login.
//         this.socketService.emit('registrar_sesion', userData);
//     }
